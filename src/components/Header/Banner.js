...
export class Banner extends Component {
    render() {
        return (
            <div>
                <section className="wow fadeIn p-0 mobile-height parallax" data-stellar-background-ratio="0.5" style={{ backgroundImage: "url(/images/homepage-option18-banner.jpg)", backgroundPosition: "0px 0px", visibility: "visible", animationName: "fadeIn" }}>
