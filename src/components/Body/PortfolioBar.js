                            ...
                            <div className="col-12 px-3 p-md-0">
                                <div className="filter-content overflow-hidden">
                                    <ul className="portfolio-grid portfolio-metro-grid work-4col hover-option8 gutter-medium" style={{ position: "relative;", height: "1940.47px;" }}>
                                        ...
                                        <li className="grid-item fadeInUp web branding photography" data-wow-delay="0.2s" style={{ position: "absolute;", left: "25%;", top: "0px;", visibility: "visible;", animationDelay: "0.2s;", animationName: "fadeInUp;" }}>
                                        ...
                                        <li className="grid-item grid-item-double design fadeInUp" data-wow-delay="0.4s" style={{ position: "absolute;", left: "50%;", top: "0px;", visibility: "visible;", animationDelay: "0.4s;", animationName: "fadeInUp;" }}>
                                        ...
                                        <li className="grid-item grid-item-double branding web fadeInUp" style={{ position: "absolute;", left: "0%;", top: "322.25px;", visibility: "visible;", animationName: "fadeInUp;" }}>
                                        ...
                                        <li className="grid-item grid-item-double advertising fadeInUp" data-wow-delay="0.2s" style={{ position: "absolute;", left: "50%;", top: "644.5px;", visibility: "visible;", animationDelay: "0.2s;", animationName: "fadeInUp" }}>
                                        ...
                                        <li className="grid-item grid-item-double web photography fadeInUp" data-wow-delay="0.4s" style={{ position: "absolute;", left: "0%;", top: "647.984px;", visibility: "visible;", animationDelay: "0.4s;", animationName: "fadeInUp;" }}>
                                        ...
                                        <li className="grid-item grid-item-double branding photography fadeInUp" style={{ position: "absolute;", left: "50%;", top: "1289px;", visibility: "visible;", animationName: "fadeInUp;" }}>
                                        ...
                                        <li className="grid-item fadeInUp web design" data-wow-delay="0.2s" style={{ position: "absolute;", left: "0%;", top: "1292.48px;", visibility: "visible;", animationDelay: "0.2s;", animationName: "fadeInUp;" }}>
                                        ...
                                        <li className="grid-item fadeInUp branding advertising" data-wow-delay="0.4s" style={{ position: "absolute;", left: "25%;", top: "1292.48px;", visibility: "visible;", animationDelay: "0.4s;", animationName: "fadeInUp" }}>
                                            <a href="single-project-page-01.html">
                                                <figure>
                                        ...
                                        <li className="grid-item grid-item-double web photography fadeInUp" style={{ position: "absolute;", left: "0%;", top: "1614.73px;", visibility: "visible;", animationName: "fadeInUp;" }}>
                                            <a href="single-project-page-02.html">
                                                <figure>
