                            ...
                            <div class="col-12 px-3 p-md-0">
                                <div class="filter-content overflow-hidden">
                                    <ul class="portfolio-grid portfolio-metro-grid work-4col hover-option8 gutter-medium" style={{ position: "relative;", height: "1940.47px;" }}>
                                        ...
                                        <li class="grid-item grid-item-double advertising fadeInUp" data-wow-delay="0.2s" style={{ position: "absolute;", left: "50%;", top: "644.5px;", visibility: "hidden;", animationDelay: "0.2s;", animationName: "none;" }}>
                                        ...
                                        <li class="grid-item grid-item-double web photography fadeInUp" data-wow-delay="0.4s" style={{ position: "absolute;", left: "0%;", top: "647.984px;", visibility: "hidden;", animationDelay: "0.4s;", animationName: "none;" }}>
                                        ...
                                        <li class="grid-item grid-item-double branding photography fadeInUp" style={{ position: "absolute;", left: "50%;", top: "1289px;", visibility: "hidden;", animationName: "none;" }}>
                                        ...
                                        <li class="grid-item fadeInUp web design" data-wow-delay="0.2s" style={{ position: "absolute", left: "0%;", top: "1292.48px;", visibility: "visible;", animationDelay: "0.2s;", animationName: "fadeInUp;" }}>
                                        ...
                                        <li class="grid-item fadeInUp branding advertising" data-wow-delay="0.4s" style={{ position: "absolute;", left: "25%;", top: "1292.48px;", visibility: "hidden;", animationDelay: "0.4s;", animationName: "none;" }}>
                                            <a href="single-project-page-01.html">
                                                <figure>
                                        ...
                                        <li class="grid-item grid-item-double web photography fadeInUp" style={{ position: "absolute;", left: "0%;", top: "1614.73px;", visibility: "hidden;", animationName: "none;" }}>
                                            <a href="single-project-page-02.html">
                                                <figure>
